...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/bheghenkz/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/bheghenkz/scriptvps/main/websocket"
